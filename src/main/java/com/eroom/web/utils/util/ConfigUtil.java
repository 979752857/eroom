...
public class ConfigUtil {
    ...
    static {
        ...
        try {
            ...
            /*
             * //is = config_class.getResourceAsStream(default_config_2); is = new
             * FileInputStream(new File(config_class.getResource(default_config_2).toURI())); if (is
             * != null) { mConfig.load(is);
             * log.info("successfully loaded custom properties file from classpath" ); } else {
    ...
    public static String getProperty(String key, String defaultValue) {
        log.debug("Fetching property [" + key + "=" + mConfig.getProperty(key) + ",defaultValue="
                + defaultValue + "]");
    ...
    public static synchronized void reloadProperties() throws Exception {
        ...
        try {
             ...
             * File(config_class.getResource(default_config_2).toURI())); if (is != null) {
             * mConfig.load(is);
             * log.info("successfully loaded custom properties file from classpath" ); } else {
             * log.info("no custom properties file found in classpath"); }
             */
