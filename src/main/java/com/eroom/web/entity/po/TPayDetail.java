...
/**
 * TPayDetail generated by hbm2java
 */
@Entity
@Table(name = "t_pay_detail", catalog = "eroom")
public class TPayDetail implements java.io.Serializable {
    ...
    public TPayDetail(long roomId, long custId, Date createTime, String state) {
        this.roomId = roomId;
        this.custId = custId;
    ...
    public TPayDetail(long roomId, long custId, String type, BigDecimal amount, Date createTime,
