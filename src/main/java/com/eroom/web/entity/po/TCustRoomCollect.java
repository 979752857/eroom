...
/**
 * TCustRoomCollect generated by hbm2java
 */
@Entity
@Table(name = "t_cust_room_collect", catalog = "eroom")
public class TCustRoomCollect implements java.io.Serializable {
    ...
    public TCustRoomCollect() {
    }

    public TCustRoomCollect(long custId, long rentId, String state, Date createTime) {
        this.custId = custId;
        this.rentId = rentId;
        this.state = state;
