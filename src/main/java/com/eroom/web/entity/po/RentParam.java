...
/**
 * RentParam generated by hbm2java
 */
@Entity
@Table(name = "t_rent_param", catalog = "eroom")
public class RentParam implements java.io.Serializable {
    ...
    public RentParam(String paramCode, String paramSubType, String paramTitle, String paramType,
