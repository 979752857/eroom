...
/**
 * TCustInfo generated by hbm2java
 */
@Entity
@Table(name = "t_cust_info", catalog = "eroom")
public class TCustInfo implements java.io.Serializable {
    ...
    public TCustInfo(String openid, String state, Date createTime, String authPhone,
            String isOwner) {
        this.openid = openid;
        this.state = state;
    ...
    public TCustInfo(String name, String phone, String qq, String wechat, String nickName,
