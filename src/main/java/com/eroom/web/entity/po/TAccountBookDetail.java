...
/**
 * TAccountBookDetail generated by hbm2java
 */
@Entity
@Table(name = "t_account_book_detail", catalog = "eroom")
public class TAccountBookDetail implements java.io.Serializable {
    ...
    public TAccountBookDetail() {
    }

    public TAccountBookDetail(long custId, long bookId, String inOutFlag, BigDecimal amount,
