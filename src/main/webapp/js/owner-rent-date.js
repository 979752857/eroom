...
function getListSuccess(result){
	...
	if(datas&&datas.length>0){
		$.each(datas,function(index,item){
			...
			html += '<a href="room-detail.html?rentId='+item.id+'"><div class="tu clearfloat"><span></span><img src="'+myUtil.getSystemCfgTitle("EROOM", "IMAGES")+myUtil.getSystemCfgTitle("EROOM", "IMAGES_ROOM")+item.bedroomImageUrl+'"/>';
